...
############################################################
    if True:
        if my_chemistry.withWater == 1:
            ## OPEN FOR COMPARISON
            with open('waterData/fC_v_Z_UMIST2012.csv') as bialyData:
            ...
            with open('waterData/fCH_v_Z_UMIST2012.csv') as bialyData:
                lines = bialyData.readlines()
                bialy_Z = []
                bialy_CH = []
                for line in lines[6:]:
            ...
            with open('waterData/fO_v_Z_UMIST2012.csv') as bialyData:
                lines = bialyData.readlines()
                bialy_Z = []
                bialy_O = []
                for line in lines[6:]:
                ...
                with open('waterData/fH2O_v_Z_UMIST2012.csv') as bialyData:
                    lines = bialyData.readlines()
                    bialy_Z = []
                    bialy_H2O = []
                    for line in lines[6:]:
                ...
                with open('waterData/fO2_v_Z_UMIST2012.csv') as bialyData:
                    lines = bialyData.readlines()
                    bialy_Z = []
                    bialy_O2 = []
                    for line in lines[6:]:
                ...
                with open('waterData/fCO_v_Z_UMIST2012.csv') as bialyData:
                    lines = bialyData.readlines()
                    bialy_Z = []
                    bialy_CO = []
                    for line in lines[6:]:
                ...
                with open('waterData/fOH_v_Z_UMIST2012.csv') as bialyData:
                    lines = bialyData.readlines()
                    bialy_Z = []
                    bialy_OH = []
                    for line in lines[6:]:
                ...
                pyplot.plot(np.log10(metallicity), np.log10(np.divide(XO,XO_tot)), label ='O', color=cols_metl[0],zorder=100)
                pyplot.plot(np.log10(metallicity), np.log10(np.divide(XC,XC_tot)), label ='C', color=cols_metl[1],zorder=100)
                pyplot.plot(np.log10(metallicity), np.log10(np.divide(XCO,XC_tot)), label ='CO', color=cols_metl[2],zorder=100)
                pyplot.plot(np.log10(metallicity), np.log10(np.divide(XH2O,XO_tot)),label ='H2O', color=cols_metl[3],zorder=100)
                pyplot.plot(np.log10(metallicity), np.log10(np.divide(XOH,XO_tot)), label ='OH', color=cols_metl[4],zorder=100)
                pyplot.plot(np.log10(metallicity), np.log10(np.divide(XO2,XO_tot)), label ='O2', color=cols_metl[5],zorder=100)
                pyplot.plot(np.log10(metallicity), np.log10(np.divide(XCH,XC_tot)), label ='CH', color=cols_metl[6],zorder=100)

                # Add results from the reduced network 
                RN = pd.read_csv("reducedNetwork/BialyTest_metals_1.00e+12.csv")
                pyplot.plot(np.log10(RN['Z']), np.log10(RN['O']), label ='O', color='k', linestyle='--',zorder=10)
                pyplot.plot(np.log10(RN['Z']), np.log10(RN['C']), label ='C', color='k', linestyle='--',zorder=10)
                pyplot.plot(np.log10(RN['Z']), np.log10(RN['CO']), label ='CO', color='k', linestyle='--',zorder=10)
                pyplot.plot(np.log10(RN['Z']), np.log10(RN['H2O']), label ='H2O', color='k', linestyle='--',zorder=10)
                pyplot.plot(np.log10(RN['Z']), np.log10(RN['OH']), label ='OH', color='k', linestyle='--',zorder=10)
                pyplot.plot(np.log10(RN['Z']), np.log10(RN['O2']), label ='O2', color='k', linestyle='--',zorder=10)
                pyplot.plot(np.log10(RN['Z']), np.log10(RN['CH']), label ='CH', color='k', linestyle='--',zorder=10)
                ...
                pyplot.tight_layout()
                pyplot.savefig("Bialy_metals_t%iGyr_N%i.pdf" %(int(final_time/1.e3),N_pts),dpi=300)
                pyplot.clf()
...
############################################################
            ...
            ## OPEN FOR COMPARISON
            with open('waterData/yH_v_Z_UMIST2012.csv') as bialyData:
                    lines = bialyData.readlines()
                    bialy_Z = []
                    bialy_H = []
                    for line in lines[6:]:
            ...
            with open('waterData/yH2_v_Z_UMIST2012.csv') as bialyData:
                    lines = bialyData.readlines()
                    bialy_Z = []
                    bialy_H2 = []
                    for line in lines[6:]:
...
#            pyplot.loglog(metallicity, np.divide(H, (2*(H2+H2plus) + H + HM + Hplus)), label ='H', color='coral')
            pyplot.plot(np.log10(metallicity), np.log10(np.divide(H2, 2*H2 + H)), label ='H2', color=cols_h2[0],zorder=100)
            pyplot.plot(np.log10(metallicity), np.log10(np.divide(H, 2*H2 + H)), label ='H',color=cols_h2[1],zorder=100)
            ...
            #pyplot.loglog(metallicity, XH2, label='H2', color='black')
                # Add results from the reduced network 
            RN_H2 = pd.read_csv("reducedNetwork/BialyTest_H2_1.00e+12.csv")
            pyplot.plot(np.log10(RN_H2['Z']),np.log10(RN_H2['H2']), label ='H2', color='k', linestyle='--',zorder=10)
            pyplot.plot(np.log10(RN_H2['Z']),np.log10(RN_H2['H2']), label ='H', color='k', linestyle='--',zorder=10)
           ...
           # leg.get_frame().set_alpha(0.5)
            ...
            pyplot.xlim(left=-5,right=0)
            pyplot.tight_layout()
            pyplot.savefig("Bialy_H2_t%iGyr_N%i.pdf" %(int(final_time/1.e3),N_pts),dpi=300)
...
############################################################
            ...
            pyplot.ylabel(r"f$_i$",fontsize=22)
            ...
            #leg.get_frame().set_alpha(0.5)
            pyplot.tight_layout()
            pyplot.savefig("Bialy_ions_t%iGyr_N%i.pdf" %(int(final_time/1.e3),N_pts),dpi=300)
